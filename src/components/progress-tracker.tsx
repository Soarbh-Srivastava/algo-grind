...
export function ProgressTracker({ solvedProblems, onUpdateProblem, onRemoveProblem }: ProgressTrackerProps) {
       ...
       <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete the problem "{problemToRemove?.title}"? This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
